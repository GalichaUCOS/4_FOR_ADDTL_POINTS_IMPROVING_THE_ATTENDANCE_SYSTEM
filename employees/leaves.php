...
<html lang="en">
  <head>
    ...
    <style>
      ...
      .page-header {
        background: linear-gradient(135deg, rgb(0, 255, 199)0%, rgb(0, 255, 199)100%);
        color: white;
        padding: 2rem;
        border-radius: 15px;
        margin-bottom: 2rem;
      ...
      .btn-primary {
        background: linear-gradient(135deg,rgb(0, 60, 255) 0%, rgb(36, 186, 255)100%);
        border: none;
      }
      
      .btn-primary:hover {
        background: linear-gradient(135deg,rgb(36, 186, 255) 0%,rgb(0, 60, 255)100%);
      }
